...
{
    extern float __opaque_a asm("_villager_worshipper_seconds_in_day_0x0099aa60");
    extern float __opaque_b asm("_villager_worshipper_num_days_in_year_0x0099aa5c");
    extern float __opaque_c asm("_villager_worshipper_seconds_in_year_0x00dcb170");
