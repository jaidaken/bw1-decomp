...
// win1.41 00734d50 mac 10534800 GStreetLantern::CreatureMustAvoid(Creature *)
bool __fastcall CreatureMustAvoid__14GStreetLanternFP8Creature(struct Object* this, const void* edx, struct Creature* param_1) asm("?CreatureMustAvoid@GStreetLantern@@UAEIPAVCreature@@@Z");
// win1.41 00734b10 mac 10534be0 GStreetLantern::SaveObject(LHOSFile &, MapCoords const &)
