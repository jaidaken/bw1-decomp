...
uint32_t Living::InitialisePhysics(const LHPoint* param_1, const LHPoint* param_2, Object* param_3, bool param_4, GInterfaceStatus* param_5)
{
    return 0;
}
...
uint32_t Villager::InitialisePhysics(const LHPoint* param_1, const LHPoint* param_2, Object* param_3, bool param_4, GInterfaceStatus* param_5)
{
    return 0;
}
...
void Villager::SetUpPhysOb(PhysOb* param_1)
{
}
