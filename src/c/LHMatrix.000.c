...
__attribute__((XOR32rr_REV, no_callee_saves, prefer_register_store, store_order("0x2c,0x28,0x24,0x1c,0x18,0x14,0x0c,0x08,0x04,0x20,0x10,0x00")))
void __fastcall Translation__8LHMatrixFv(struct LHMatrix* this, const struct LHPoint* translation)
{
    ...
    *(unsigned int*)((char*)this + 0x28) = *(const unsigned int*)((const char*)translation + 0x04);
    {
        register unsigned int last asm("edx");
        asm volatile("" : "=d"(last) : "0"(*(const unsigned int*)((const char*)translation + 0x08)));
        *(unsigned int*)((char*)this + 0x2c) = last;
    }
}
