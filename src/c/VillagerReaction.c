...
{
    asm volatile (
        "%{disp32%} fld  dword ptr [_villager_reaction_seconds_in_day_0x0099a9d8]\n\t"
        "%{disp32%} fmul dword ptr [_villager_reaction_num_days_in_year_0x0099a9d4]\n\t"
        "%{disp32%} fstp dword ptr [_villager_reaction_seconds_in_year_0x00db9e34]"
        ::: "memory"
    );
}
