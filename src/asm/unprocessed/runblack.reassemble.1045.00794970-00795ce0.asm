...
.extern ?StartScript@ChallengeRoom@@QAEIK@Z
...
.globl ?StartScript@Temple@@QAEIK@Z
...
?StartScript@Temple@@QAEIK@Z:
                         ...
                         call               ?StartScript@ChallengeRoom@@QAEIK@Z          // 0x00794a28    e8e301ffff
