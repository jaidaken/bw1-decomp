...
void FUN_0075a760(void)
{
}

// win1.41 0075a770 mac 10579a00 Villager::SetupMoveAroundFire(MapCoords const &, VILLAGER_STATES)
bool32_t Villager::SetupMoveAroundFire(const MapCoords& param_1, VILLAGER_STATES param_2)
{
    return false;
}
...
bool32_t Villager::IsValidFire(FireEffect* param_1)
{
    return false;
}
...
bool32_t Villager::SetupOnFire(FireEffect* param_1)
{
    return false;
}
