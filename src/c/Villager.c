...
{
    asm volatile (
        "%{disp32%} fld  dword ptr [_villager_seconds_in_day_0x0099a1e8]\n\t"
        "%{disp32%} fmul dword ptr [_villager_num_days_in_year_0x0099a1e4]\n\t"
        "%{disp32%} fstp dword ptr [_villager_seconds_in_year_0x00da6be4]"
        ::: "memory"
    );
}
...
{
    asm volatile (
        "%{disp32%} fld  dword ptr [_villager_float_0x0099a1ec]\n\t"
        "%{disp32%} fmul dword ptr [_abode_info_float_0x008a99f0]\n\t"
        "%{disp32%} fstp dword ptr [_villager_float_0x00da6be0]"
        ::: "memory"
    );
}
