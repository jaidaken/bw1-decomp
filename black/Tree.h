...
// win1.41 0055d8f0 mac 10159620 Tree::IsResourceStore(RESOURCE_TYPE)
bool __fastcall IsResourceStore__4TreeF13RESOURCE_TYPE(struct Object* this, const void* edx, enum RESOURCE_TYPE param_1) asm("?IsResourceStore@Tree@@UAEIW4RESOURCE_TYPE@@@Z");
// win1.41 0074b820 mac 10157510 Tree::GetResourceType(void)
...
// win1.41 0074c0e0 mac 10156590 Tree::CreatureMustAvoid(Creature *)
bool __fastcall CreatureMustAvoid__4TreeFP8Creature(struct Object* this, const void* edx, struct Creature* param_1) asm("?CreatureMustAvoid@Tree@@UAEIPAVCreature@@@Z");
// win1.41 0074a180 mac 10158cd0 Tree::AddToRoutePlan(RPHolder *, Creature *, int, void (*)(int, Point2D, float, int))
