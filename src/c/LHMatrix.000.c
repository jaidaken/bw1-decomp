...
__attribute__((XOR32rr_REV, store_order("0x2c,0x28,0x24,0x1c,0x18,0x14,0x0c,0x08,0x04,0x20,0x10,0x00")))
void __fastcall Translation__8LHMatrixFv(struct LHMatrix* this, const struct LHPoint* translation)
{
    ...
    p[0] = zero;
    asm volatile("" ::: "memory");
    p[9] = *(unsigned int*)((char*)translation + 0x00);
    p[10] = *(unsigned int*)((char*)translation + 0x04);
    p[11] = *(unsigned int*)((char*)translation + 0x08);
}
