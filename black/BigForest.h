...
// win1.41 004394e0 mac 100b2760 BigForest::Load(GameOSFile &)
bool __fastcall Load__9BigForestFR10GameOSFile(struct GameThing* this, const void* edx, struct GameOSFile* file) asm("?Load@BigForest@@UAEIAAVGameOSFile@@@Z");
// win1.41 00439470 mac 100b2840 BigForest::Save(GameOSFile &)
...
// win1.41 00438f50 mac 100b3530 BigForest::CreatureMustAvoid(Creature *)
bool __fastcall CreatureMustAvoid__9BigForestFP8Creature(struct Object* this, const void* edx, struct Creature* param_1) asm("?CreatureMustAvoid@BigForest@@UAEIPAVCreature@@@Z");
// win1.41 00438dd0 mac 100b2420 BigForest::VillagerMustAvoid(Villager *)
