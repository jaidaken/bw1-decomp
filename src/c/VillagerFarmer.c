...
bool32_t __fastcall EnterFarming__8VillagerFUcUc(struct Villager* this, const void* edx, unsigned char param_1, unsigned char param_2)
{
    ...
    asm volatile (
        ...
        "test               eax, eax\n\t"
        "%{disp8%} jne        LAB__addr_0x0075a263\n\t"
        "xor.s              eax, eax\n\t"
        "pop                esi\n\t"
        "ret                0x0008\n"
        "LAB__addr_0x0075a263:\n\t"
        ...
        "test               eax, eax\n\t"
        "%{disp8%} jne        LAB__addr_0x0075a296\n\t"
        "mov                edx, dword ptr [esi]\n\t"
        "mov.s              ecx, esi\n\t"
...
bool32_t __fastcall ExitFarming__8VillagerFUc(struct Villager* this, const void* edx, unsigned char param_1)
{
    ...
    asm volatile (
        ...
        "test               eax, eax\n\t"
        "%{disp8%} jne        LAB__addr_0x0075a303\n\t"
        "%{disp32%} mov       eax, dword ptr [esi + 0x00000118]\n\t"
        "test               eax, eax\n\t"
        "%{disp8%} je         LAB__addr_0x0075a303\n\t"
        "mov                edx, dword ptr [esi]\n\t"
        "mov.s              ecx, esi\n\t"
        "call               dword ptr [edx + 0x48]\n\t"
        ...
        "%{disp32%} mov       ecx, dword ptr [esi + 0x00000118]\n\t"
        "%{disp8%} je         LAB__addr_0x0075a303\n"
        "LAB__addr_0x0075a2e2:\n\t"
        "cmp.s              eax, ecx\n\t"
        "%{disp8%} je         LAB__addr_0x0075a2f9\n\t"
        "%{disp32%} mov       eax, dword ptr [eax + 0x000000c4]\n\t"
        "test               eax, eax\n\t"
        "%{disp8%} jne        LAB__addr_0x0075a2e2\n\t"
        "mov                eax, 0x00000001\n\t"
        "pop                esi\n\t"
        "ret                0x0004\n"
        "LAB__addr_0x0075a2f9:\n\t"
        "test               eax, eax\n\t"
        "%{disp8%} je         LAB__addr_0x0075a303\n\t"
        "push               esi\n\t"
