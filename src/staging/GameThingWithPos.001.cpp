...
MapCoords* GameThingWithPos::GetArrivePos()
{
    return NULL;
}
...
uint32_t GameThingWithPos::GetOrigin() const
{
    return 0;
}

// win1.41 004052a0 mac 103e1210 GameThingWithPos::GetLife(void)
float GameThingWithPos::GetLife() const
{
    return 0.0f;
}
...
uint32_t GameThingWithPos::GetCreatureMimicType() const
{
    return 0xa;
}
...
float GameThingWithPos::GetHeight() const
{
    return 0.0f;
}

// win1.41 00405510 mac 10003460 GameThingWithPos::SetInScript(int)
void GameThingWithPos::SetInScript(int32_t param_1)
{
}
