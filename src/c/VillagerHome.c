...
{
    asm volatile (
        "%{disp32%} fld  dword ptr [_villager_home_seconds_in_day_0x0099a998]\n\t"
        "%{disp32%} fmul dword ptr [_villager_home_num_days_in_year_0x0099a994]\n\t"
        "%{disp32%} fstp dword ptr [_villager_home_seconds_in_year_0x00db9e18]"
        ::: "memory"
    );
}
