...
{
    asm volatile (
        "%{disp32%} fld  dword ptr [_villager_dance_seconds_in_day_0x0099a954]\n\t"
        "%{disp32%} fmul dword ptr [_villager_dance_num_days_in_year_0x0099a950]\n\t"
        "%{disp32%} fstp dword ptr [_villager_dance_seconds_in_year_0x00db9df8]"
        ::: "memory"
    );
}
